<h2><a href="https://practice.geeksforgeeks.org/problems/print-diagonally1623/1?page=2&difficulty[]=1&status[]=unsolved&category[]=Matrix&sortBy=submissions">Anti Diagonal Traversal of Matrix</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Give a N*N square <strong>matrix</strong>, return an array of its anti-diagonals. Look at the example for more details.</span></p>
