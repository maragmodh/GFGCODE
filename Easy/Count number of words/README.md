<h2><a href="https://practice.geeksforgeeks.org/problems/count-number-of-words1500/1?page=1&sortBy=submissions&searchQuery=word">Count number of words</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a string consisting of spaces,\t,\n and lower case&nbsp; alphabets.Your task is to count the number of words where spaces,\t and \n work as separators.</span><br>
&nbsp;</p>
