<h2><a href="https://practice.geeksforgeeks.org/problems/largest-odd-number-in-string/1?page=2&sortBy=submissions&searchQuery=largest">Largest odd number in string</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an string<strong> S</strong>, representing a large interger. Return the<strong><em>&nbsp;</em>largest-valued odd&nbsp;</strong>integer (as a string) that is substring of the given string <strong>S</strong>.</span></p>
