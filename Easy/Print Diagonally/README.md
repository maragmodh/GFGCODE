<h2><a href="https://practice.geeksforgeeks.org/problems/print-diagonally4331/1?page=1&difficulty[]=0&category[]=Matrix&sortBy=submissions">Print Diagonally</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Give a <strong>N * N</strong> square matrix <strong>A</strong>, return all the elements of its anti-diagonals from <strong>top to bottom</strong>. </span></p>
