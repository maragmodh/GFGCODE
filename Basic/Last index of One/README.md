<h2><a href="https://practice.geeksforgeeks.org/problems/last-index-of-15847/1?page=2&difficulty[]=-1&status[]=solved&sortBy=submissions">Last index of One</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a string <strong>S</strong> consisting only '<strong>0</strong>'s and '<strong>1</strong>'s,&nbsp; find the last index of the '1' present in it. </span></p>
